...
const DialogOverlay = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        'bg-background-darker/80 data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 fixed inset-0 z-50',
        props.class
      )}
      {...rest}
    />
